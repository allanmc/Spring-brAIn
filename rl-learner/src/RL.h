...
#define REWARD_METAL_MAX 20.0
//8.0
#define REWARD_METAL_STATES 4
#define REWARD_METAL_STORE_MIN 0
#define REWARD_METAL_STORE_MAX 1000
#define REWARD_METAL_STORE_STATES 4
#define REWARD_ENERGY_MIN -100.0
#define REWARD_ENERGY_MAX 50.0
//26.0
#define REWARD_ENERGY_STATES 4
#define REWARD_ENERGY_STORE_MIN 0 
#define REWARD_ENERGY_STORE_MAX 1000
#define REWARD_ENERGY_STORE_STATES 4
//#define GAMMA 0.9f
extern float GAMMA;
//#define ALPHA 0.1f
extern float ALPHA;
